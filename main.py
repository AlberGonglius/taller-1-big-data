...
st.subheader("La apliación está compuesta por dos secciones: Noticias y taxis, las cuales corresponden al punto 1 y 2 del taller respectivamente. Selecione una de las dos opciones del menú de la izquierda para ver las soluciones del Taller.")